...
function Select(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("label", { children: placeholder }), (0, jsx_runtime_1.jsxs)("select", __assign({}, (name && register(name)), props, { children: [(0, jsx_runtime_1.jsx)("option", { value: "", disabled: true, children: 'Selectionner' }), options &&
